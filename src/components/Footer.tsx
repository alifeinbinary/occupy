...
export default function Footer() {
    ...
    return (
        <footer id="footer" className="mt-24 sm:mt-6 px-4 py-2 w-full bg-white rounded-lg shadow md:flex md:items-center md:justify-between">
            ...
            <div className="sm:mt-4 flex flex-wrap items-center mt-3 text-sm text-gray-500">
                ...
                <div className='sm:w-1/2 md:w-56 text-right'>
                    <a id="imdb" onClick={() => gaEventTracker('imdb')} className="inline-block text-bergundy no-underline hover:text-stone-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out" href="https://www.imdb.com/title/tt2401752/?ref_=ext_shr_lnk">
